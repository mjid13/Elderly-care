...
<?php endif; ?>
  ...
  <aside><a href="Control_admin1.php" ><h6>Control<br>(for admin)</h6></a></aside>
  
  <?php endif; ?>
<h1 >Service
<br>
<h4>move by hospital car</h4>
<br></h1>
<form method="post">
	<table class="auto-style2" style="width: 100%">
	<tr>
		<td style="width: 110px">Place:</td>
		<td><select name="choose_way">
		
		<option value="from hospital to home">from hospital to home</option>
		<option value="from home to hospital">from home to hospital</option>
		</select></td>
	</tr>
		<tr>
		<td style="width: 110px">Address start:</td>
		<td><input name="Add_start" type="text" /></td>
		</tr>
		<tr>
		<td style="width: 110px">Address finish:</td>
		<td><input name="Add_finish" type="text" /></td>
		</tr>
		<tr>
		<td style="width: 110px">Date:</td>
		<td><input name="Date_Service" type="date" /></td>
		</tr>
		<td style="width: 110px">Time:</td>
		<td><input name="Time_Service" type="time" /></td>
		</tr>

</table>


	<input name="Submit_Service" type="submit" value="submit" /><input name="Reset1" type="reset" value="reset" />
	</form>
...
<?php
	 ...
	 include 'dbconnection.php';
		...
		if(isset($_POST['Submit_Service']))
			...
			if(!empty($_POST['choose_way']) 
				&& !empty($_POST['Add_start']) 
				&& !empty($_POST['Add_finish']) 
				&& !empty($_POST['Date_Service'])
				&& !empty($_POST['Time_Service']))
				...
				
			{
				  ...
				  $sql="INSERT INTO `service`(`place`, `start_address`, `finish_distention_address`,`date`,`time`, `username` ) VALUES (:pla,:sta,:fin,:da,:ti,'$gg')";
				$stmt=$conn->prepare($sql);
				$stmt->execute(array(
				':pla'=>$_POST['choose_way'],
				':sta'=>$_POST['Add_start'],
				':fin'=>$_POST['Add_finish'],
				':da'=>$_POST['Date_Service'],
				':ti'=>$_POST['Time_Service'],
