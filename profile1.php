...
<?php
 include 'dbconnection.php';
	//code for select
			...
			//$sql=â€‌select * from studentâ€‌;
			//$stmt=$conn->query($sql);
			// Or 
			$stmt = $conn->query("SELECT `id`, `username`, `password`, `Email`, `Gender`, `Phone_Number`, `address` FROM `users` WHERE username='$NNN'");
			$rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
			$n=$stmt->rowCount();
			
			if($n>0)  	// if($stmt->rowCount()>0)
			{
				echo "<table border='1' class='auto-style2'>";
				echo "<tr>";
					echo "<th>Civil ID</th>";
					echo "<th>Name</th>";
					echo "<th>Email</th>";
...
<table class="auto-style8" style="width: 100%">
	<tr>
		<td style="height: 23px">Civil id:</td>
		<td style="height: 23px">
		<input name="T_Civil_id" style="width: 206px" type="text" /></td>
	</tr>
	<tr>
		<td style="height: 23px">Username;</td>
		<td style="height: 23px">
		<input name="T_Username" style="width: 206px" type="text" /></td>
	</tr>
	<tr>
		<td style="height: 23px">Password:</td>
		<td style="height: 23px">
		<input name="T_Password" style="width: 206px" type="password" /></td>
	</tr>
	<tr>
		<td style="height: 23px">Email:</td>
		<td style="height: 23px">
		<input name="T_Email" style="width: 206px" type="text" /></td>
	</tr>
	<tr>
		<td style="height: 23px">Phone Number:</td>
		<td style="height: 23px">
		<input name="T_Phone_number" style="width: 206px" type="text" /></td>
	</tr>
	<tr>
		<td style="height: 23px">Address:</td>
		<td style="height: 23px">
		<input name="T_Address" style="width: 206px" type="text" /></td>
	</tr>
</table>


	<input name="update" type="submit" value="update" /><input name="Reset1" type="reset" value="reset" />
	</form>
...
<?php
	...
	if(isset($_POST['update']))
		$us=$_SESSION['username'];
			...
			if(!empty($_POST['T_Civil_id'])
                && !empty($_POST['T_Username'])				
				&& !empty($_POST['T_Password']) 
				&& !empty($_POST['T_Email'])
				&& !empty($_POST['T_Phone_number'])
				&& !empty($_POST['T_Address']))
			{

				
				$enpassword = password_hash($_POST['T_Password'], PASSWORD_DEFAULT);
				$sql="update users set id=:u_ID, username=:usern, password=:passw, Email=:Emai ,Phone_Number=:phone_n , address=:add where username='$us'";
				$stmt=$conn->prepare($sql);
				
				$stmt->execute(array(
				':u_ID'=>$_POST['T_Civil_id'],
				':usern'=>$_POST['T_Username'],
				':passw'=>$enpassword ,
				':Emai'=>$_POST['T_Email'],
				':phone_n'=>$_POST['T_Phone_number'],
				':add'=>$_POST['T_Address']
	...
	?>
<h2>Join member team</h2>

<details>
  <summary>What is member team?</summary>
  <p>It is the team that participate in help the older by offer their car to transfor them</p>
</details>
...
<table class="auto-style8" style="width: 100%">
	<tr>
		<td style="height: 23px">Car Plate:</td>
		<td style="height: 23px">
		<input placeholder="type your car number note not allow to join if you do not own car" name="carnu" style="width: 390px" type="text" required /></td>
	</tr>
	<tr>
		<td style="height: 23px">Car Type:</td>
		<td style="height: 23px">
		<select name="cartp" style="width: 114px">
...
<input name="submitmember" type="submit" value="join" /><input name="Reset1" type="reset" value="reset" />
</form>
</details>
...
<?php
		...
		if(isset($_POST['submitmember']))
			...
			if(!empty($_POST['carnu']) 
				&& !empty($_POST['cartp']))
				
			{
				
				
				$sql="INSERT INTO `member`(`Member_ID`,`Car_number`, `username`, `car_tp`,`address`) VALUES (:id,:carr,:un ,:catp ,:ad)";
				$stmt=$conn->prepare($sql);
				$stmt->execute(array(
				':id'=>$uid,
				':carr'=>$_POST['carnu'],
