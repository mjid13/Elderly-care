...
$sql="INSERT INTO que (question, username) VALUES (:qu, :un)";
...
{
$deletL = "<a href='deleteque.php?id={$row['questionid']}' onclick=\'return confirm('Are you sure want to delete this Question?');\'>delete question</a>";
}
...
echo "<td style='width: 110px'>{$row['username']}</td>";
echo "</tr>";
echo "<tr>";
...
echo "</table>";
echo "<td> | <a href='answcont.php?id={$row['questionid']}'>Answer</a></td>";
