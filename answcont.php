...
<h1 >Quick Contact
<br>
<h4>question been ask before</h4>
<br></h1>

<?php
include 'dbconnection.php';
if(isset($_GET['id']) && isset($_POST['answer']) && isset($_POST['aSubmit'])){
$id = $_GET['id'];
$sql="update que set answer = :an where questionid='$id'";
...
$sql = "select * from que where questionid='$id'";
$stmt = $conn-> query($sql);
...
echo '<table class="auto-style2" style="width: 100%">';

echo "<tr>";
echo "<td style='width: 110px'>Question:</td>";
$quedate= date(" j.n.y | g:i a ", strtotime($row['quedate']));
echo "<td>{$row['question']}</td>";
echo "</tr>";
echo "<tr>";
echo '<td style="width: 130px">date|time:</td>';
echo "<td>$quedate</td>";
echo "</tr>";
echo '<tr style="background-color:#d27315">';
echo '<td style="width: 130px">Answer:</td>';
echo "<td>{$row['answer']}</td>";
echo '<td><input name="answer" type="text" /> | <input name="aSubmit" type="submit" value="submit" /></td>';
echo "</tr>";

echo "</table>";
echo "<td><a href='Quick_Contact1.php'>Back</a></td>";
...
<?php
include 'dbconnection.php';
if(isset($_POST['question']) && isset($_POST['qSubmit'])){
$sql="INSERT INTO qee (question) VALUES (:qu)";
...
<h2>insert your question</h2>

<form method="post">
	<table class="auto-style2" style="width: 100%">

		<tr>
		<td style="width: 110px">Question:</td>
		<td><input name="question" type="text" /></td>
		</tr>
		
</table>
	<input name="qSubmit" type="submit" value="submit" /><input name="Reset1" type="reset" value="reset" />
	</form>
